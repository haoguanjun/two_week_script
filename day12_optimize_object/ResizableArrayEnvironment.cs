...
namespace week2
{
    public class ResizableArrayEnvironment : ArrayEnvironment
    {
        ...
        public ResizableArrayEnvironment(IOptimizeEnvironment outer) : base(10, outer)
        {
            names = new Symbols();
        }
        ...
        {
            IOptimizeEnvironment env = Where(name);
            if (env == null)
            {
                env = this;
            }
        ...
        public override IOptimizeEnvironment Where(string name)
        {
